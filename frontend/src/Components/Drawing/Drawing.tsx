...
import {clearDrawing, updateDrawing, updateDrawingLine} from "../../Reducers/Drawing";
...
const Drawing = () => {
    ...
    const drawing: DrawingModel = useSelector((state: any) => state.drawing.drawing)
    ...
    const sendUpdate = async () => {
        ...
        const statement = prepareStatement({
            ...
            uuid: uuid,
            // points: LZUTF8.encodeBase64(
            //     LZUTF8.compress(
            //         JSON.stringify(lastLine.points)
            //     )),
    ...
    const handleMouseDown = async (e: any) => {
        ...
        dispatch(updateDrawing(
            {uuid, tool, color, points: [pos.x, pos.y]}
        ))
