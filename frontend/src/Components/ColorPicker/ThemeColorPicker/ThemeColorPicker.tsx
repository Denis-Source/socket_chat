...
export const ThemeColorPicker = () => {
    ...
    return (
        <div className={styles.wrapper}>
            <ReactSlider value={cookies.theme} min={0} max={BACKGROUND_COLORS.length - 1} className={styles.picker}
                         thumbClassName={styles.thumb}
                         trackClassName={styles.track} onChange={onChange}/>
            <img className={styles.icon} src={themeIcon} alt={Strings.ThemeIconDesc}/>
        </div>);
};
